...
<style>
    * { box-sizing: border-box; }
    ...
    .hero .eyebrow { text-transform: uppercase; letter-spacing: 1.5px; font-size: 14.5px; color: #e9c9ce; margin-bottom: 10px; }
    ...
    .card p.tagline { color: #6e1423; font-size: 15.5px; text-align: center; margin: 0 0 10px; }
    ...
    .welcome-box .role-badge { display: inline-block; background: rgba(110,20,35,0.12); color: #6e1423; padding: 2px 8px; border-radius: 10px; font-size: 12.5px; text-transform: uppercase; margin-left: 6px; }

    .btn-row { display: flex; flex-direction: column; gap: 10px; }
    .btn { display: block; text-align: center; text-decoration: none; padding: 12px 18px; border-radius: 6px; font-size: 16.5px; font-weight: bold; }
    ...
    .btn-text { text-align: center; font-size: 14.5px; color: #888; text-decoration: none; margin-top: 4px; }
    .btn-text:hover { color: #611a15; }

    footer { text-align: center; color: #888; font-size: 14.5px; padding: 0 20px 40px; }
