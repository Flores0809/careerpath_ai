-- CareerPath AI: schema.sql + all migrations' DATA statements, concatenated in order,
-- for one-shot import into a fresh Railway MySQL database.
-- Structural (CREATE TABLE / ADD COLUMN / ADD CONSTRAINT / etc.) statements from the
-- individual migration files were stripped out, since schema.sql already reflects the
-- final, current table structure -- only each migration's DATA changes (INSERT/UPDATE/
-- DELETE) are kept, to avoid 'duplicate column'/'already exists' errors on a fresh DB.
-- This runs entirely against whichever database your client is already connected to.

-- ==== schema.sql (structure only, DB-selection lines removed) ====
...
-- ==== migration_2_ai_enrichment.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE pending_careers


-- ==== migration_3_users_auth.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
...
-- ==== migration_4_student_accounts.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
...
-- ==== migration_7_international_sources.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE pending_careers
...
-- ==== migration_8_skills_verification.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE skill_requirements
-- [skipped: already covered by schema.sql] ALTER TABLE student_profiles


-- ==== migration_9_counselor_outcomes.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE counselor_log


-- ==== migration_10_consultations_notifications_settings.sql ====
...
-- ==== migration_11_career_categories.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE careers
-- [skipped: already covered by schema.sql] ALTER TABLE pending_careers
-- [skipped: already covered by schema.sql] ALTER TABLE student_profiles
...
-- ==== migration_12_expand_careers.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
...
-- ==== migration_13_category_management.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
...
-- [skipped: already covered by schema.sql] CREATE INDEX idx_change_log_table_record ON change_log (table_name, record_id);
-- [skipped: already covered by schema.sql] CREATE INDEX idx_change_log_changed_at ON change_log (changed_at);


-- ==== migration_15_key_subjects.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE careers ADD COLUMN key_subjects VARCHAR(255) NULL AFTER educational_
-- [skipped: already covered by schema.sql] ALTER TABLE pending_careers ADD COLUMN key_subjects VARCHAR(255) NULL AFTER care
...
-- ==== migration_16_student_access_code.sql ====
...
INSERT IGNORE INTO system_settings (setting_key, setting_value, description) VALUES
    ('student_access_code', 'MEII2026', 'Code students must enter to self-register. Share this only with MEII students (e.g. announce it in class or print it on ID handouts);
 change it here if it leaks.');


-- ==== migration_17_default_admin.sql ====
...
-- ==== migration_18_notification_categories.sql ====
-- [skipped: already covered by schema.sql] ALTER TABLE notifications
...
-- ==== migration_19_career_scope.sql ====
-- [skipped: already covered by schema.sql] ALTER TABLE careers


-- ==== migration_20_pending_career_skills.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
...
-- ==== migration_21_student_ai_commentary.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE student_profiles


-- ==== migration_22_student_career_insights.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
...
-- ==== migration_24_student_number.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE students


-- ==== migration_25_student_age.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE students


-- ==== migration_26_pending_career_link.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
-- [skipped: already covered by schema.sql] ALTER TABLE pending_careers
...
-- ==== migration_26b_backfill_only.sql ====
-- [skipped: already covered by schema.sql] USE careerpath_ai;
